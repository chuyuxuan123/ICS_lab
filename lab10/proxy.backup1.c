...
void doit(int connfd, struct sockaddr_in *sockaddr)
{
    ...
    int request_tmp, response_tmp, read, write;
    ...
    // if (requset_body_size != 0)
    // {
    //     request_tmp = requset_body_size;
    //     while (request_tmp > 0)
    //     {
    //         /* code */
    //         read = Rio_readnb_w(&client_rio, client_buf, 1);
    //         if ((read <= 0) && (request_tmp > 1))
    //         {
    //             Close(serverfd);
    //             return;
    //         }

    //         write = Rio_writen_w(serverfd, client_buf, 1);
    //         if (write != 1)
    //         {
    //             Close(serverfd);
    //             return;
